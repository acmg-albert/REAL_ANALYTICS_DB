...
This module handles the scraping of new renter affordability data from Zillow.
...
class RenterAffordabilityScraper:
    """负责从Zillow抓取租房者可负担能力数据的爬虫类"""
    
    BASE_URL = "https://www.zillow.com/research/data/"
    CSV_PATTERN = r'https:\\?/\\?/files\.zillowstatic\.com\\?/research\\?/public_csvs\\?/new_renter_affordability\\?/Metro_new_renter_affordability.*?\.csv\?t=\d+'
