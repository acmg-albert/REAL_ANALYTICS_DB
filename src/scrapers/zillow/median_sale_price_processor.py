"""
Zillow Median Sale Price Processor

This module handles the processing of median sale price data from Zillow,
...
class MedianSalePriceProcessor:
    """处理Zillow房屋销售中位数价格数据的类"""
    ...
    def _transform_data(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            df_long = pd.melt(
                ...
                var_name='date',
                value_name='median_sale_price_all_home'
            )
            ...
            # 处理空值
            processed_df['median_sale_price_all_home'] = processed_df['median_sale_price_all_home'].replace(
    ...
    def _validate_processed_data(self, df: pd.DataFrame) -> Tuple[bool, Optional[str]]:
        ...
        try:
            ...
            expected_cols = ['region_id', 'size_rank', 'region_name', 'region_type', 
                           'state_name', 'date', 'median_sale_price_all_home']
    ...
    def process(self, input_file: Path) -> Path:
        ...
        try:
            ...
            output_path = Path("data") / f"processed_zillow_median_sale_price_{timestamp}.csv"
